...
public class IllegalJavaScriptNameError extends ErrorAlert {
  public IllegalJavaScriptNameError(SourcePosition pos, String name) {
    super(pos, "Illegal javascript name: " + name);
  }

  public IllegalJavaScriptNameError(Node node, String name) {
