 ...
 * {@code gxp:ph} tag was found without a closing {@code gxp:peh} tag.
 */
public class PhMissingEphError extends ErrorAlert {
  public PhMissingEphError(SourcePosition pos, String displayName) {
    super(pos, "Unclosed " + displayName + " tag.");
  }
