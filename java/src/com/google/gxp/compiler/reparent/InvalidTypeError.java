 ...
 * invalid type was specified.
 */
public class InvalidTypeError extends ErrorAlert {

  /**
   * @param type the invalid {@code Type}.
   */
  public InvalidTypeError(Type type) {
    // TODO(laurence): come up with a better way of naming the Type?
    this(type.getSourcePosition(), type.getClass().getSimpleName());
  }

  public InvalidTypeError(SourcePosition sourcePosition, String typeName) {
    super(sourcePosition, typeName + " not allowed here.");
  }
}
