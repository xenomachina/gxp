 ...
 * duplicate {@code Import} was found.
 */
public class DuplicateImportError extends ErrorAlert {
  public DuplicateImportError(SourcePosition pos, String imp) {
    super(pos, "Duplicate Import: " + imp);
  }

  public DuplicateImportError(Import imp) {
    this(imp.getSourcePosition(), imp.getTarget());
  }
}
