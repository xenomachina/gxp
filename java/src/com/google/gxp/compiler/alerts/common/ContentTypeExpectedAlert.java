...
public class ContentTypeExpectedAlert extends ErrorAlert {
  public ContentTypeExpectedAlert(SourcePosition sourcePosition,
    ...
    super(sourcePosition, formatMessage(displayName, suffix));
  }

  private static String formatMessage(String displayName, String suffix) {
    return "Type for " + displayName + " must be content type " + suffix;
  }
}
