...
/**
 * {@code ErrorAlert} that indicates that a message was invalid in some way and
 * could not be extracted.
 */
public class InvalidMessageError extends ErrorAlert {
  private final InvalidMessageException invalidMessageException;
   ...
   */
  public InvalidMessageError(SourcePosition sourcePosition, String message) {
    super(sourcePosition, message);
    this.invalidMessageException = null;
  }
}
