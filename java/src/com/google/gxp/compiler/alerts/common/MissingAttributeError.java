...
public class MissingAttributeError extends ErrorAlert {
  public MissingAttributeError(SourcePosition nodePosition, String nodeName,
                               String attrName) {
    super(nodePosition,
          nodeName + " must have an '" + attrName + "' attribute");
  }

  public MissingAttributeError(Node node, String attrName) {
