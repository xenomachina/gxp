 ...
 * {@code gxp:param} attatched to a {@code gxp:template} has a
 * {@code has-constructor} attribute.
 */
public class TemplateParamWithHasConstructorError extends ErrorAlert {
  public TemplateParamWithHasConstructorError(SourcePosition pos) {
    super(pos, "Template parameters do not take a has-constructor attribute.");
  }
